...
<div class="header" style="background-color: deepskyblue">
    <div class="container">
        <nav class="navbar navbar-default" role="navigation" style="background-color: deepskyblue;border-color: white;border: 1px">
            <div class="navbar-header">
                ...
                <h1 class="navbar-brand"><a href="/index">木梓蛋糕店</a></h1>
            </div>
            <!--navbar-header-->
